        ...
        Task<OrganizerPanel> task = new Task<OrganizerPanel>() {
            ...
            protected OrganizerPanel call() throws Exception {
                ...
                if (isMainOrganizerOfEvent(eventId, organizerId)) {
                    ...
                    Platform.runLater(() -> {
                        view[0] = new MainOrganizerView(stage, eventsScene, organizerName, organizerId, context);
                    });
                    return view[0];
                ...
                if (isSubOrganizerOfEvent(eventId, organizerId)) {
                    ...
                    Platform.runLater(() -> {
                        view[0] = new SubOrganizerView(stage, eventsScene, organizerName, organizerId);
                    });
                    return view[0];
                }
